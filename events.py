...
# driver.get(f"https://104.26.5.249/{event_names[2]}/register")
...
#   for row in rows:
#       # Find all cells (columns) within the row
#       cells = row.find_elements(By.TAG_NAME, "td")

#       # Iterate through each cell in the row
#       for cell in cells:
#           try:
#             # Find the link element within the cell
...
# except NoSuchElementException:
#    print("Could not find match results table")
